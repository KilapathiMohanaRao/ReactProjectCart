        ...
        <div className="row d-flex flex-wrap">
          {currentItems.length > 0 ? (
            currentItems.map((item) => {
              ...
              return (
                <div className="juice-card shadow-sm d-flex flex-column mb-4" key={item.id}>
                  <img
                    src={item.image}
                    alt={item.name}
                    ...
                    {qty === 0 ? (
                      ...
                      <div className="d-flex justify-content-between align-items-center mt-auto">
                        <button
                          ...
                          onClick={() => {
                            handleRemove(item);
                            toast.error(`Product ${item.name} decreasing quantity`);
                          }}
                        >
                          −
                        </button>
                        ...
                        <button
                          ...
                          onClick={() => {
                            handleAdd(item);
                            toast.info(`Product ${item.name} increasing quantity`);
                          }}
                        >
                          +
                        </button>
            ...
            <p className="text-center text-muted w-100">
              No juices found for this price range.
            </p>
          )}
        </div>
